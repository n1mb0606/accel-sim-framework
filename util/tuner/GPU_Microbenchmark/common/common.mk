...
CUOPTS =  $(GENCODE_ARCH) $(GENCODE_SM50) $(GENCODE_SM60) $(GENCODE_SM62) $(GENCODE_SM70) $(GENCODE_SM75) $(GENCODE_SM80) $(GENCODE_SM86) $(GENCODE_SM89)

CC := nvcc

CUDA_PATH ?= /usr/local/cuda-11.8/
INCLUDE := $(CUDA_PATH)/samples/common/
LIB :=
